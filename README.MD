...
- <span style="color:pink"> ** proto** </span> is an internal reference pointing to the object’s prototype.
- It forms the _prototype chain_, which JavaScript uses to resolve properties and methods.
